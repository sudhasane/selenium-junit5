...
public class AcmeBankSteps {
    // This Cucumber step definition class contains everything needed to run a full visual test against the ACME bank site.
    ...
    public static void setUpConfigAndRunner() {
        ...
        batch = new BatchInfo("Example: Selenium Java Cucumber with the " + runnerName);
